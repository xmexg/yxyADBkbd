...
public class GUI {
	...
	public void start() {
		...
		container_main.addMouseListener(new MouseListener() {//v2.3的双击删除一个文字
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if (arg0.getClickCount() >= 2) {
					cmd.commonmain("adb shell am broadcast -a ADB_INPUT_CODE --ei code 67", false);//回删键
				}
			}
		...
		jtextarea_input.setForeground(new Color(242, 230, 206));
		// 按钮部分
...
//		jlabel_useless.setBackground(Color.orange);//标签背景颜色
		jlabel_useless.setForeground(new Color(173, 101, 47));// 标签字体颜色
